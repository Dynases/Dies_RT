...
Public Class PR_CertiAlumnosEscAprobados
#Region "Metodos Privados"
    Private Sub _prIniciarTodo()
        _PMIniciarTodo()
        Me.Text = "p o s t u l a n t e s    a p r o b a d o s    d e    l a    e s c u e l a".ToUpper

        MReportViewer.ToolPanelView = CrystalDecisions.Windows.Forms.ToolPanelViewType.None
    End Sub
    Private Sub _prCargarReporte()
        Dim _dt As New DataTable
        _dt = L_prAlumnoCertiGetAprobadosEscuelaConSuInstructor()
        ...
        If (_dt.Rows.Count > 0) Then
            Dim objrep As New R_CertiAlumnosEscuelaAprobados
