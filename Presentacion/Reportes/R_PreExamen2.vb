...
Public Class R_PreExamen2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_PreExamen2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ParamFecha() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_conNota() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR_PreExamen2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_PreExamen2 = New R_PreExamen2()
        rpt.Site = Me.Site
        Return rpt
    End Function
